...
<body class="home-body">
    ...
    <div id="home-main" class="home-container">
        ...
        <div class="home-info_container">
            <p class="home-info_text">Obtén playlists y álbumes inspirados por los artistas y <br> géneros que escuchas. 1 mes gratis, luego $129.00 al mes.</p>
            ...
            <a class="home-url" href="#">Consulta el plan de estudiante <svg width="6" height="9" viewBox="0 0 6 9" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div id="home-modal_login" class="home-modal home-modal_login" style="display: none">
        ...
        <p class="home-modal_text">Puedes iniciar sesión si ya tienes una cuenta o te ayudaremos a crear una.</p>
        <form class="home-modal_form" action="POST">
            <input class="home-modal_input home-modal_text" type="email" placeholder="Correo Electrónico" required>
            <input class="home-modal_input home-modal_text"  type="password" placeholder="Contraseña" required>
            <input class="button button-accent" type="submit" value="Continuar">
        </form>
        <span class="home-modal_text_small">La información de tu cuenta de RIEAV se usa para permitirte iniciar sesión de manera segura y para acceder a tus datos. RIEAV recopila determinados datos por motivos de  seguridad, soporte y elaboración de informes. Si estás de acuerdo, RIEAV también
podría usar la información de tu cuenta de RIEAV para enviarte correos electrónicos de marketing y comunicaciones, los cuales incluyen aquellos que se basan en tu uso de los servicios de RIEAV</span>
    </div>
    ...
    <div id="home-modal_register" class="home-modal home-modal_register" style="display: none">
        <div class="home-modal_register_container">
            ...
            <form class="home-modal_form" action="POST">
                <div class="home-modal_form_field">
                    <input class="home-modal_input home-modal_text" type="email" placeholder="Correo Electrónico" required>
                    <span class="home-modal_text_small">Esta dirección de correo eléctronico será tu cuenta de RIEAV</span>
                </div>
                <div class="home-modal_form_field">
                    <input class="home-modal_input home-modal_text"  type="password" placeholder="Contraseña" required>
                    <span class="home-modal_text_small">Tu contraseña debe tener como mínimo 8 caracteres, letras en mayúsculas y minúsculas, y al menos un número</span>
                </div>
                <input class="home-modal_input home-modal_text"  type="text" placeholder="Nombre" required>
                <input class="home-modal_input home-modal_text"  type="text" placeholder="Apellidos" required>
                <input class="home-modal_input home-modal_text"  type="date" placeholder="Fecha de Nacimiento" required>
                <input class="home-modal_input home-modal_text"  type="text" placeholder="País/Región" required>
                <div class="home-modal_form_check">
                    <input type="checkbox" id="terms" name="terms" required>
                    <label for="terms" class="home-modal_text_small">Aceptar Términos y Condiciones</label>
                </div>
                <hr>
                <span class="home-modal_text_small">Al seleccionar Continuar, aceptas los Términos y Condiciones de los Servicios multimedia de RIEAV y reconoces que iniciarás sesión en este navegador.</span>
            </form>
        </div>
