...
<main class="player-main">
    <aside class="player-container player-sidebar">
        ...
        <form class="player-search_form" onsubmit="return false;" aria-disabled="true" style="opacity:0.5; pointer-events:none; cursor:not-allowed";>
            <img alt="Buscar" src="<?php echo BASE_ASSETS; ?>img/icons/search.svg">
            <input class="player-search_input" placeholder="Buscar" disabled>
        </form>
        ...
        <div class="player-list_container">
            <ul class="player-menu">
                ...
                <li class="player-menu_item" aria-disabled="true" style="opacity:0.5; pointer-events:none; cursor:not-allowed;">
                    <div class="player-menu_item_icon_container">
